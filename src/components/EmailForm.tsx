...
export function EmailForm({ onEmailSubmit }: EmailFormProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-2 py-10 relative gap-[50px]">
      ...
      {/* Content based on showEmailForm state */}
      {!showEmailForm ? (
        ...
        // Email Form Content
        <div className="w-full max-w-xl mx-auto flex flex-col items-center relative z-10 transition-opacity duration-500 ease-in-out">
