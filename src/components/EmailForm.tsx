...
export const EmailForm: React.FC<EmailFormProps> = ({ onEmailSubmit }) => {
  ...
  // Triggers the state change to show the email form
  const handlePlayClick = () => {
    setShowWelcomeScreen(false);
  };

  // Derived state for email validity
  const isValidEmail = email.trim() && validateEmail(email);

  // Dynamically set the background image based on the view
